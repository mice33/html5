 ...
 *   });
 *
 *   DemoModel.getInstance().execute(function(data){
 ...
 *
 */
define(['cCoreInherit', 'cAbstractStore', 'cHeadStore','cUserStore','cMarketStore','cMobileTokenStore','cAbstractModel', 'cUtilObject'],
  function (cCoreInherit, AbstractStore, cHeadStore, cUserStore,cMarketStore,cMobileTokenStore,baseModel, cObject) {
