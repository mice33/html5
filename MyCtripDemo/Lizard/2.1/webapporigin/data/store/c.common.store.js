 ...
 */
define(['cCoreInherit', 'cUserStore', 'cHeadStore', 'cMarketStore','cMobileTokenStore'], function (cCoreInherit, cUserStore, cHeadStore, cMarketStore,cMobileTokenStore) {
  var Common = {};
  ...
  /**
   * 手机号查询Token store
   * @var Store.cMobileTokenStore
   */
  Common.MobileTokenStore =cMobileTokenStore;
