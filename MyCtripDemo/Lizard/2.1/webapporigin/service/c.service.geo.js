 ...
 */
define(['cUtilPerformance', 'cLocalStore', 'cCoreInherit', 'cGuiderService', (Lizard.app.code.is('MASTER') || Lizard.app.code.is('YOUTH') || Lizard.isHybrid) ? 'cHybridGeolocation' : 'cWebGeolocation'],
